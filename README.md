...
新增了配置卡住告警 超过一定时间没有下一把做手动告警（仓库大小被暗改更小了 清理有时候会失败 10把清理一次挂了4个多小时紫玉也多 仓库溢出卡住了 告警手动通知）
全输出390沙男可以带两个一百多级在1分半内打完 都懒得玩了 后台挂着刷刷通行证经验 和 聚义厅活跃 一天4级、3天12级，一赛季算2个月24天96级
****************************************************************************************************************
2023-2-20
